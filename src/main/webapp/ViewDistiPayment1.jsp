				...
				<div class="col-md-12">
					<div class="col-lg-12"><br><br>
						<div class="text-center color-elements">
							...
							<h3>
								<b>Distributor Payment Details</b>
							</h3>
							<br>
							<br>
						</div>
					...
					<table class="table table-bordered">
                     ...
                     Statement st=con.createStatement();
                      ResultSet rs=st.executeQuery("select * from paydist where name='" +name+ "'"); 
                    /*  ResultSet rs=st.executeQuery("select * from pay where name='" +name+ "'"); */
                     /*  ResultSet rs=st.executeQuery("select * from pay where name='"+name+"'");  */
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	do{	 
                    	 ...
                    	 %>
									...
									<TR>
			                            ...
			                            <td><a href="DeleteDistiPayCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td> 
