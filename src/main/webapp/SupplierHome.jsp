          ...
          <div class="col-lg-7 pt-4 pt-lg-0 content">
            ...
            <div class="row">
              <div class="col-lg-3">
                ...
                <a href="ViewSupPay.jsp"><input type="button" style="color:white" class="about-btn" value="View Payment"></a>
  ...
  <div class="modal fade" id="myModal" role="dialog">  
    <div class="modal-dialog">  
      ...
      <div class="modal-content">
            ...
            <br>
          <h4 class="modal-title" align="center">Sell Raw Material</h4>
        ...
        <div class="modal-body" align="center">  
          <form action="AddRawMaterialCon" method="post">
            ...
            <label>Supplier Name</label>
             <input type="text" name="suppliername" required pattern="[a-zA-Z\s]+" title="Enter suppliername" class="form-control custom-labels" required="required"  value="${name}" readonly/>                                
                </div>
            <div class="form-group mt-1">
             <input type="text" name="materialname" required pattern="[a-zA-Z\s]+"  class="form-control custom-labels" placeholder="Enter Material Name" required="required" />                                
                </div>             
