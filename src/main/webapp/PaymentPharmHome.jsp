...
<center><div class="w3-container">  
  ...
  <button class="w3-button w3-blue-grey" style="width:230px;" data-toggle="modal" data-target="#myModal" ><a style="color:white;">Add Payment</a></button><br><br>  
  <button class="w3-button w3-blue-grey" style="width:230px;"><a href="BuyOrderPayment.jsp" style="color:white;">Add Customer Payment</a></button><br><br>
 
 <!--  <button class="w3-button w3-blue-grey" style="width:230px;"><a href="" style="color:white;">View Customer Payment</a></button><br><br>
   -->
</div></center>
</div>
<div class="col-lg-6">
  ...
  <div class="modal fade" id="myModal" role="dialog">  
    <div class="modal-dialog">  
      ...
      <div class="modal-content">  
        ...
        <form action="PaymentDistiCon" method="post">
            ...
            <div class="form-group mt-1">
             <input type="text" name="name" required pattern="[a-zA-Z\s]+" class="form-control custom-labels" required="required"  placeholder="Enter Name" />                                
               ...
               <div class="form-group mt-1 mt-1 mt-md-0">
                <input type="text" name="ifsc" class="form-control custom-labels" title="Enter ifsc" required="required" placeholder="Enter IFSC Code" />
              </div>
              <div class="form-group mt-1">
