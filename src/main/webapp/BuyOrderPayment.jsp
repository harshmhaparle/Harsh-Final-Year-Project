...
<div class="w3-container">  
   <center><form action="BillMedicineCon" method="post">
              ...
              <div class="form-group mt-1">
             <input type="text" name="email"  class="form-control custom-labels" placeholder="Enter Email" required/>                                
              </div>  
              <!-- <div class="form-group mt-1">
             <input type="text" name="text" required pattern="[a-zA-Z\s]+" class="form-control custom-labels" placeholder="Enter tablet Name" readonly/>                                
              </div>  -->
              <div class="form-group mt-1">
             <input type="text" name="payment"  class="form-control custom-labels" placeholder="Enter Payment" required/>                                
              </div> 
              <br>
