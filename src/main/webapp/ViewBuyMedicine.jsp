			...
			<div class="row">
				<div class="col-md-12">
					...
					<table class="table table-bordered">
                     ...
                     ResultSet rs=st.executeQuery("select buymed.id,patient.name,patient.email,patient.address,patient.mobileno,buymed.image,buymed.imagename,buymed.date,buymed.status,buymed.statuss from buymed inner join patient on buymed.email=patient.email");
                    	 ...
                    	 %>
								 ...
								 <th>Status</th>
									...
									<TR>
                                        ...
                                        --%>
                                        <td><center><button style="background-color:green;"><a style="color:white;"href="BuyOrderPayment.jsp">Create Bill</button></a></center></td>
