    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="SupplierLogin.jsp">Ingredient Supplier</a></li>
  ...
  <section id="userreg" class="userreg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title"><br>        
          <p>Ingredient Supplier Registration</p>
                  </div>  
            ...
            <div class="form-group mt-1">
             <input type="text" name="name" required pattern="[a-zA-Z\s]+" title="Enter Your Name(eg.abc)" class="form-control custom-labels" required="required"  placeholder="Enter Name" />                                
              ...
              <div class="form-group mt-1">
              <input type="text" name="email" class="form-control custom-labels" title="" required pattern="^[A-Za-z0-9+_.-]+@(.+)$" required="required" placeholder="Enter Email" />
              </div>
              <div class="form-group mt-1">
