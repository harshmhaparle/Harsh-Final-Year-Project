			...
			<div class="container"> 
				<div class="row">
                    ...
                    <th > Name   </th>
                     ...
                     ResultSet rs=st.executeQuery("select adddrug.id,manufacturer.name, manufacturer.address, manufacturer.email, manufacturer.mobileno,adddrug.image, adddrug.imagename, adddrug.categoryname, adddrug.drugname, adddrug.hashcode, adddrug.drugprice, adddrug.drugdesc, adddrug.date, adddrug.status,adddrug.statuss from adddrug inner join manufacturer on adddrug.email=manufacturer.email");
                     ...
                     if(rs.next() == false) {
                    	...
                    	<%--  <td style="color:black"><%=rs.getString(6) %></td>  --%>
                    	 <td><img alt="Profile Pic" class="img-circle" src="AddDrugPic.jsp?id=<%=rs.getInt(1) %>"  width="100px" height="80px"/></td>
                    	 ...
                    	 <th><a href="DrugApprovalCon?id=<%=rs.getInt(1)%>&statuss=<%=rs.getString(15)%>"><%=rs.getString(15)%></a></th> 
