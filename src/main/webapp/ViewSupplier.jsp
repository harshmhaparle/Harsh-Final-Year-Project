				...
				<div class="col-md-12">
					<div class="col-lg-12"><br><br>
						<div class="text-center color-elements">
							...
							<h3>
								<b>View Ingredient Supplier Data</b>
							</h3>
							<br>
							<br>
						</div>
					...
					<table class="table table-bordered">
                     ...
                     /* ResultSet rs=st.executeQuery("select * from supplier where email='"+email+"'"); */
                    	...
                    	do{	 
                    	 ...
                    	 %>
									...
									<TR>
			                           ...
			                           <td><a href="DeleteSupCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
