                    ...
                    <th > Name   </th>
                     ...
                     if(rs.next() == false) {
                    	...
                    	do{	 
                    	 ...
                    	 <%--  <td><center><button style="background-color:green;"><a style="color:white;"href="Sendtonext?id=<%=rs.getInt(1)%>&status=<%=rs.getString(14)%>"><%=rs.getString(14)%></button></a></center></td>
