...
/**
 * Servlet implementation class DrugApprovalCon
 */
@WebServlet("/DrugApprovalCon")
public class DrugApprovalCon extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DrugApprovalCon() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(dao.UpdateDrugApprovalStatus(id, statuss))
		{
			ResultSet rs=dao.SelectManu();
			if(rs!= null)
			{
