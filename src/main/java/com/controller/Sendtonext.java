...
/**
 * Servlet implementation class Sendtonext
 */
@WebServlet("/Sendtonext")
public class Sendtonext extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(dao.UpdateSendNextBatch(id, status))
		{
			ResultSet rs=dao.SelectSendNextBatch();
			if(rs!= null)
			{
