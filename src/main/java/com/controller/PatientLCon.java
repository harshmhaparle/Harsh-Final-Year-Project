...
/**
 * Servlet implementation class PatientLCon
 */
@WebServlet("/PatientLCon")
public class PatientLCon extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PatientBean user=dao.CheckPatient(email, password);
