...
/**
 * Servlet implementation class ManufacturerLoginCon
 */
@WebServlet("/ManufacturerLoginCon")
public class ManufacturerLoginCon extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManufacturerLoginCon() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PatientBean user=dao.CheckManufacturer(email, password);
