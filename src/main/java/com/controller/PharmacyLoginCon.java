...
/**
 * Servlet implementation class PharmacyLoginCon
 */
@WebServlet("/PharmacyLoginCon")
public class PharmacyLoginCon extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PharmacyLoginCon() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PatientBean user=dao.CheckPharmacy(email, password);
		...
		else if((user.getEmail()!=null && user.getEmail()!="") && (user.getPassword()!=null && user.getPassword()!=""))
		{
			...
			out.println("location='PharmacyHome.jsp';");
			out.println("</script>");
